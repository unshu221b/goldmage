...
class CreditProduct(models.Model):
    ...
    name = models.CharField(max_length=100)  # e.g., "Small Pack", "Medium Pack", "Large Pack"
    description = models.TextField(blank=True)
    credits = models.IntegerField()  # Number of credits in this package
    price_usd = models.DecimalField(max_digits=10, decimal_places=2)  # Price in USD
...
class CreditPurchase(models.Model):
    ...
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='credit_purchases')
